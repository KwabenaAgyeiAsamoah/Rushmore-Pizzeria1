...
def mask_email(email: str) -> str:
    ...
    Example: kwabgyei75@evample.com  -> k*@example.com
    """
...
if __name__ == "__main__":
    ...
    populate_logger.info("Executing RushMore Pizzeria1 data generation script...")
    main()
    elapsed = datetime.now() - start_time
    populate_logger.info(
        f"Data generation completed in {elapsed.seconds // 60} min {elapsed.seconds % 60} sec."
    )